...
class TestInjectCredentials:
    def test_simple_https(self):
        out = _inject_credentials(
            "https://github.com/user/repo.git", "oauth2", "ghp_abcdef"
        )
    ...
    def test_preserves_explicit_port(self):
        out = _inject_credentials(
            "https://gitlab.example.com:8443/foo/bar.git", "oauth2", "tok"
        )
        parsed = urlparse(out)
    ...
    def test_quotes_at_sign_in_token(self):
        ...
        out = _inject_credentials(
            "https://github.com/foo/bar.git", "oauth2", "ab@cd"
        )
    ...
    def test_alphanumeric_passes_through_unchanged(self):
        ...
        out = _inject_credentials(
            "https://gitlab.com/x.git", "oauth2", "glpat-ABC_123.456-xyz"
        )
